...
-- which customer use discount but still spent more than the avg purchase amount
...
-- do subcribed customer spend more? compare avg spend and total revenue
-- between subcribersand non-subscribers.
...
-- no of previous purchases, and show the ciunt of each segment
...
-- are customers who are repeat buyers (morethan 5 privious purchases)also likely to subscribe?
...
-- what is the revenue cotribution of each age group?
